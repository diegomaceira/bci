...
class BciApplicationTests extends Specification {
	...
	public void givenUserObject_whenCreateUser_thenReturnSavedUser() throws Exception {
		...
		phones.add(new Telephone(1234,3,"ARG"));
		phones.add(new Telephone(4567,2,"CHI"));
		
		// given - precondition or setup
		User employee = new User("diego","maceira@diego.com","asDcv34rt",phones);
	...
	public void givenUpdatedEmployee_whenUpdateEmployee_thenReturnUpdateEmployeeObject() throws Exception {
		// given - precondition or setup
		long employeeId = 1L;
		Employee savedEmployee = Employee.builder().firstName("Ramesh").lastName("Fadatare").email("ramesh@gmail.com")
				.build();
